...
// import { generateId } from "@/lib/utils"; // ID is now generated by service caller or service itself
...
interface AddClassFormProps {
  onSubmit: (data: LopHoc) => void; // onSubmit will receive the full LopHoc object for editing, or form values for adding
  initialData?: LopHoc | null;
  onClose: () => void;
  isSubmitting?: boolean;
}

export default function AddClassForm({ onSubmit, initialData, onClose, isSubmitting }: AddClassFormProps) {
  const form = useForm<ClassFormValues>({
    resolver: zodResolver(classFormSchema),
    defaultValues: initialData ? {
      ...initialData,
      lichHoc: initialData.lichHoc as string[], // Ensure lichHoc is string array
  ...
  function handleSubmit(data: ClassFormValues) {
    const classData: LopHoc = {
      id: initialData?.id || '', // For new classes, ID will be handled by the mutation/service
      ...data,
      lichHoc: data.lichHoc as DayOfWeek[],
      soHocSinhHienTai: initialData?.soHocSinhHienTai || 0, // Preserve if editing
      trangThai: initialData?.trangThai || 'Đang hoạt động', // Preserve if editing
    };
    onSubmit(classData);
  }
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end gap-2 pt-4">
          ...
          <Button type="submit" className="bg-primary hover:bg-primary/90 text-primary-foreground" disabled={isSubmitting}>
            {isSubmitting ? "Đang lưu..." : (initialData ? TEXTS_VI.saveButton : TEXTS_VI.addClassTitle)}
          </Button>
        </div>
      </form>
    </Form>
